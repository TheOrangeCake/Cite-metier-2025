...
def custom_draw(screen, state):
	...
	# Check for non-existent variable safely
	if "non_existent_variable" in state:
		print("Found hidden value:", state["non_existent_variable"])
	else:
		# This is safe - we're just checking, not using it
		pass
